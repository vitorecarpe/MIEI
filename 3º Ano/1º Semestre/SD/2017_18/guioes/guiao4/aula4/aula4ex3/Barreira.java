...
/*
Implemente uma classe Barreira que ofereça um método esperar() cujo objectivo é garantir
que cada thread que o invoque se bloqueie até que o número de threads nesta situação
tenha atingido o valor N, passado ao construtor. Um objecto Barreira deverá poder ser reutilizado
em sucessivas invocações de esperar() (e.g., para uma sincronização ao fim de
cada uma de várias etapas de uma execução).
*/
...
public class Barreira {
	...
	public synchronized void esperar(){
		...
		if(this.counterElem==this.maxElem){
			this.notifyAll();
			System.out.println("A barreira tem " + this.counterElem + "/"+this.maxElem+" elementos na etapa "
				+counterEtapa+" -> Thread "+Thread.currentThread().getName()+" acorda outras threads");
